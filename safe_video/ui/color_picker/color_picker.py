# This file is from the flet_contrib library: https://github.com/flet-dev/flet-contrib/blob/main/flet_contrib/color_picker/src/color_picker.py
# line 158 and 200 had to be changed to fit our flet version.
